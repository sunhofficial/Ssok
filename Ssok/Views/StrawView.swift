...
struct StrawView: View {
    ...
    var body: some View {
        if !st{
            ...
            case .face:
                CameraEndingView(wheresentence: Where, whatsentence: String(What.missionTitle.dropLast(2)), missionTitle: What.missionTitle, missionTip: What.missionTip, missionColor: What.missionColor)
            }
        }
    }
}
