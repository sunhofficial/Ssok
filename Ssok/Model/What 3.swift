...
Mission(missionType: .voice, missionTitle: "혀 놀리기 👅", missionTip: "장소로 이동해서 미션하기 버튼을 누르고\n주어진 문장을 읽을 준비 후 말하기 버튼을 눌러\n시간 안에 크고 정확하게 따라 읽어요!", missionColor: .blue, goal: "경찰청 쇠창살 외철창살, 검찰청 쇠창살 쌍철창살", timer: 10.0),
    Mission(missionType: .blink, title: "플러팅하기", description: "장소로 이동해서 미션하기 버튼을 누르고\n얼굴을 인식시켜 미션 완료까지 두 눈을 윙크하세요!", mainColor: .mint, arstate: "blink"),
    Mission(missionType: .smile, title: "팀원웃기기", description: "장소로 이동해서 미션하기 버튼을 누르고\n얼굴을 인식시켜 미션 완료까지 웃으세요!", mainColor: .mint, arstate: "smile")
]
