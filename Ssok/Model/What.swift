...
let missions = [
    Mission(missionType: .decibel,
        ...
        goal: "60"),
    Mission(missionType: .decibel,
            missionTitle: "콧바람 장풍 불기 💨",
            missionTip: "장소로 이동해서 미션하기 버튼을 누르고\n콧바람을 불어서 목표 데시벨을 채우세요.",
            missionColor: Color("MissionDecibel"),
            goal: "50"),
//    Mission(missionType: .decibel,
//            missionTitle: "크게 노래 부르기 🎵",
...
//            missionTitle: "혀 놀리기 👅",
//            missionTip: "장소로 이동해서 미션하기 버튼을 누르고\n주어진 문장을 읽을 준비 후 말하기 버튼을 눌러\n시간 안에 크고 정확하게 따라 읽어요!",
//            missionColor: Color("MissionVoice"),
//            goal: "들의 콩깍지는 깐 콩깍지인가 안 깐 콩깍지인가",
//            timer: 10.0),
//    Mission(missionType: .voice,
//            missionTitle: "영국 신사 되기 💂🏻‍♀️",
//            missionTip: "장소로 이동해서 미션하기 버튼을 누르고\n주어진 문장을 읽을 준비 후 말하기 버튼을 눌러\n영국 발음으로 읽어야만 성공할 수 있어요!",
//            missionColor: Color("MissionVoice"),
//            goal: "Could I have a bottle of water please",
//            timer: 10.0),
//    Mission(missionType: .voice,
//            missionTitle: "바보 되기 🤪",
